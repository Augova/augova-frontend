...
export function AnomalousMatterVisual({ color = "#659287" }: { color?: string }) {
  ...
  useEffect(() => {
    ...
    // detail=64 in the source snippet would generate ~335M triangles and hang
    // the tab; 5 gives a smooth wireframe at this display size.
